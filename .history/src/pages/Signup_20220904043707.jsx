...
function Signup() {
  ...
  return (
    <div className="bg-red-600 min-h-screen flex flex-row justify-center items-center gap-4">
      <div className="flex flex-col bg-red-600">
        <div className="bg-red-600 w-[500px] h-[316px] drop-shadow-xl rounded-xl px-3">
